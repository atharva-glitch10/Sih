...
function ImageQuality() {
  ...
  const { imageInfo, patient, iqa } = useScreening();
    ...
    <div className="iqa-page">
      ...
      <div className="iqa-header">
        <div>
          ...
          <p>
            NETRA has analyzed the retinal fundus image for patient {patient.name || patient.id} for AI readiness.
          </p>
        </div>
      ...
      <div className="iqa-grid">
        ...
        <div className="iqa-card image-card">
          <div className="card-title">
            ...
            <div>
              <h3>Fundus Image Preview</h3>
              <p>{imageInfo?.name || "Selected fundus image"}</p>
            </div>
          </div>

          <div className="fundus-preview" style={{ background: '#000', borderRadius: '8px', minHeight: '260px', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
            {imageInfo?.previewUrl ? (
              <img
                src={imageInfo.previewUrl}
                alt="Fundus examination preview"
